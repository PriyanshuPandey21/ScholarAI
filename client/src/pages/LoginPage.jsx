    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      <motion.div initial={{ opacity: 0, y: 30, scale: 0.95 }} animate={{ opacity: 1, y: 0, scale: 1 }} transition={{ duration: 0.5 }} className="glass rounded-3xl p-10 w-full max-w-md text-center relative z-10">
        ...
        <div className="flex flex-col gap-4 mb-8">
          <a href="/auth/google" className="flex items-center justify-center gap-3 w-full py-3.5 px-6 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all font-medium text-white">
          ...
          <a href="/auth/github" className="flex items-center justify-center gap-3 w-full py-3.5 px-6 rounded-xl border border-white/10 bg-white/5 hover:bg-white/10 hover:border-white/20 transition-all font-medium text-white">
